...
<div style="position:absolute;top:1083;right:325"><span class="ft1">{{number_format(((-1)*$data['doc']->descuento),0,",",".")}}</span></div>
...
$h = 498;?>
    ...
    $h = $h + 18;
    ?>
<div style="position:absolute;top:950;left:40"><span class="ft3">Referencias:</span></div>
<div style="position:absolute;top:968;left:40"><span class="ft3">ANULA DOCUMENTO DE LA REFERENCIA - Fact.Electronica N° {{$data['doc']->factura}} del 2016-06-03</span></div>
